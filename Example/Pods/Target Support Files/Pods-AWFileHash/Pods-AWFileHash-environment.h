...
// AWFileHash
#define COCOAPODS_POD_AVAILABLE_AWFileHash
#define COCOAPODS_VERSION_MAJOR_AWFileHash 1
#define COCOAPODS_VERSION_MINOR_AWFileHash 0
#define COCOAPODS_VERSION_PATCH_AWFileHash 0
